...
const MENTOR_INTRO = `You are ProjectAmazonPH Mentor, an AI assistant that helps Filipino VAs learn Amazon PPC. 
...
Most VAs skip step 3. That's why their ACoS is 40%+ while the pros run at 20%.`;
  ...
  if (lower.includes('hello') || lower.includes('hi') || lower.includes('hey')) {
    return `Hey! I'm your ProjectAmazonPH Mentor. Ask me anything about Amazon PPC — campaign structure, bidding, keywords, ACoS, TACoS, search term optimization, or how to land your first PPC client.

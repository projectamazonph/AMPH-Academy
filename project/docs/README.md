...
│   │   ├── page.tsx              # Main app (dashboard, modules, simulations)
...
The project is built by a team of 5 specialized development agents. See [`agents-spec.md`](./reference/agents-spec.md) for the full specification.
...
### Core Principles
1. **Deterministic First** — All scoring, logic, and rules are deterministic.
...
*Last updated: 2026-06-30 — AI Mentor features removed; v0.3.0*
